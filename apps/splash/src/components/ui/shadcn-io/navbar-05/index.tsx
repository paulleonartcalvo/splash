...
const NotificationMenu = ({
  ...
  // Filter out "all" type items for count calculation
  const itemNotifications = notifications.filter(n => n.type === "item");
  const allNotifications = notifications.filter(n => n.type === "all");
  const actualCount = notificationCount ?? itemNotifications.length;
...
export type { UserMenuItem, NotificationItem };
